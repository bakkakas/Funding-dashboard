...
export const I18N = {
  ko: {
    ...
    supportExchange:'지원 거래소', sortLongFavored:'Long 유리순', sortShortFavored:'Short 유리순', pair:'페어', currentFundingFee:'현재 펀딩피(주기)',
    ...
    positiveLegend:'양수 = Long -> Short', negativeLegend:'음수 = Short -> Long',
    ...
    authSynced:'모든 메뉴에서 같은 Supabase 계정을 사용해.',
    authLocal:'모든 메뉴에서 같은 Supabase 계정을 사용해.',
    authDefault:'모든 메뉴에서 같은 Supabase 계정을 사용해.',
  ...
  en: {
    ...
    supportExchange:'Supported exchange', sortLongFavored:'Long favored', sortShortFavored:'Short favored', pair:'Pair', currentFundingFee:'Current funding fee (interval)',
    ...
    positiveLegend:'Positive = Long -> Short', negativeLegend:'Negative = Short -> Long',
    ...
    authSynced:'The same Supabase account is used across every section.',
    authLocal:'The same Supabase account is used across every section.',
    authDefault:'The same Supabase account is used across every section.',
