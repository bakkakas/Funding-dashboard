...
export const I18N = {
  ko: {
    ...
    supportExchange:'지원 거래소', sortFavored:'Long/Short 유리 위로', sortFavoredOn:'유리순 적용 중', pair:'페어', currentFundingFee:'현재 펀딩피(주기)',
  ...
  en: {
    ...
    supportExchange:'Supported exchange', sortFavored:'Long/Short favored first', sortFavoredOn:'Favored first on', pair:'Pair', currentFundingFee:'Current funding fee (interval)',
